...
sudo apt-get install -y -qq devscripts debhelper scratch autoconf build-essential libtool autotools-dev automake pkg-config bsdmainutils curl ca-certificates ccache python3 rsync git libssl-dev libboost-all-dev
