...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("moneysupply",   ValueFromAmount(pindexBest->nMoneySupply - GetBurnAmount())));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <galaxycashaddress>\n"
            "Return information about <galaxycashaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <galaxycashpubkey>\n"
            "Return information about <galaxycashpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <galaxycashaddress> <signature> <message>\n"
