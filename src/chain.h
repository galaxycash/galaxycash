...
public:
    ...
    // galaxycash
    // galaxycash: money supply related block index fields
    int64_t nMint;
    int64_t nMoneySupply;

    // galaxycash: proof-of-stake related block index fields
    unsigned int nFlags; // galaxycash: block index flags
    enum {
    ...
    int GetBlockAlgorithm() const
    {
        return GetBlockHeader().GetAlgorithm();
    }
