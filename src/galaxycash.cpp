...
const std::string CScriptKeywords[] = {
    "break",
    "case",
    "catch",
    "const",
...
const std::string CScriptKeywordBeforeExpr[] = {
    "return",
    "new",
    "delete",
    "throw",
...
const std::string CScriptKeywordOperator[] = {
    "in",
    "instanceof",
    "typeof",
    "new",
...
class CScriptSymbol;
typedef std::shared_ptr<CScriptSymbol> CScriptSymbolRef;
...
class CScriptSymbol : public std::enable_shared_from_this<CScriptSymbol>
{
public:
    typedef std::shared_ptr<CScriptSymbol> Ref;

    Ref ns;


    CScriptSymbol();
    virtual ~CScriptSymbol();


    bool isVariable() const { return false; }
    bool isValue() const { return false; }
    bool isPrototype() const { return false; }
    ...
    bool isCallable() const { return false; }
    bool isFunction() const { return false; }
    bool isImport() const { return false; }
    bool isExport() const { return false; }
    bool isModule() const { return false; }
    bool isPubkey() const { return false; }
    bool isPrivkey() const { return false; }
    bool isWifkey() const { return false; }
    bool isAddress() const { return false; }
    bool isTransaction() const { return false; }
    bool isBlock() const { return false; }
    bool isChain() const { return false; }
    bool isBignum() const { return false; }


    virtual int Type() const { return SYMBOL_UNDEFINED; }
    virtual int ValueType() const { return VALUE_NULL; }
    virtual std::string ValueTypeName() { return ValueTypeNames[ValueType()]; }
    virtual std::string TypeName() const { return SymbolTypeNames[Type()]; }
    ...
    virtual Ref Clone()
    {
        return std::make_shared<CScriptSymbol>();
    }
...
class CScriptValue : public CScriptSymbol, public std::enable_shared_from_this<CScriptValue>
{
public:
    ...
    virtual int Type() const { return SYMBOL_VALUE; }
    virtual std::string TypeName() const { return SymbolTypeNames[Type()]; }
