...
static const unsigned int DEFAULT_MISBEHAVING_BANTIME = 60 * 24; // Default one-hour ban

/** galaxycash: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
private:
    ...
    friend class CActiveMasternode;
};
...
public:
    ...
    uint256 hashCheckpointKnown; // galaxycash: known sent sync-checkpoint
    ...
    // galaxycash: used to detect branch switches
