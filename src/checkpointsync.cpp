...
// galaxycash: synchronized checkpoint (centrally broadcasted)
...
// galaxycash: get last synchronized checkpoint
...
// galaxycash: only descendant of current sync-checkpoint is allowed
...
// galaxycash: reset synchronized checkpoint to last hardened checkpoint
...
// galaxycash: verify signature of sync-checkpoint message
bool CSyncCheckpoint::CheckSignature()
{
    const CPubKey& key = Params().DevPubKey();
...
// galaxycash: process synchronized checkpoint
