...
{ //  name                      actor (function)         okSafeMode threadSafe reqWallet
  //  ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "getlastblock",           &getlastblock,           false,     false,     false },
    ...
    { "getnetworkhashps",       &getnetworkhashps,       true, 	    false,	   true },
    ...
    { "dumppubkey",             &dumppubkey,             false,     false,     true },
