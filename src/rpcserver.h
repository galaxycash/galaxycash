...
#ifndef _GALAXYCASHRPC_SERVER_H_
#define _GALAXYCASHRPC_SERVER_H_ 1
...
/**
 * GalaxyCash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value getlastblock(const json_spirit::Array& params, bool fHelp);
