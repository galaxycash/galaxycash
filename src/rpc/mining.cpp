...
UniValue GetNetworkHashPS(int lookup, int height)
{
    ...
    //ppcTODO - redo this to fit galaxycash
...
// galaxycash: get network Gh/s estimate
...
UniValue generatetoaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            "2. address      (string, required) The address to send the newly generated galaxycash to.\n"
...
UniValue getmininginfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"errors\": \"...\"            (string) DEPRECATED. Same as warnings. Only shown when galaxycashd is started with -deprecatedrpc=getmininginfo\n"
            "}\n"
            "\nExamples:\n" +
...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "    https://github.com/galaxycash/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/galaxycash/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/galaxycash/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/galaxycash/bips/blob/master/bip-0145.mediawiki\n"
...
UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    // galaxycash: check block before attempting to sign it
    CValidationState state;
