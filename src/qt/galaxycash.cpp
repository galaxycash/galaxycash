...
#if defined(GCH_NEED_QT_PLUGINS) && !defined(_GCH_QT_PLUGINS_INCLUDED)
#define _GCH_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
{
    return QCoreApplication::translate("galaxycash-core", psz).toStdString();
}
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", GalaxyCashGUI::tr("A fatal error occurred. GalaxyCash can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        if(AppInit2(threadGroup))
        {
            ...
            // Shutdown the core and its threads, but don't exit GalaxyCash-Qt here
