...
{
    return QCoreApplication::translate("galaxycash", psz).toStdString();
}
...
int main(int argc, char* argv[])
{
    ...
    QSslSocket::sslLibraryVersionString(); // An unnecessary check to solve issue #14273: galaxycash-qt stops while switching SSLv3 to TLS on Arch Linux
