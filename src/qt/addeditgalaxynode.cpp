...
#include "ui_addeditgalaxynode.h"
...
AddEditGalaxyNode::AddEditGalaxyNode(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::AddEditGalaxyNode)
{
    ui->setupUi(this);

}

AddEditGalaxyNode::~AddEditGalaxyNode()
{
    delete ui;
}


void AddEditGalaxyNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:7604)");
        msg.exec();
        return;
    }
...
void AddEditGalaxyNode::on_cancelButton_clicked()
{
    reject();
}

void AddEditGalaxyNode::on_AddEditAddressPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->addressLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditGalaxyNode::on_AddEditPrivkeyPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
    ui->privkeyLineEdit->setText(QApplication::clipboard()->text());
}

void AddEditGalaxyNode::on_AddEditTxhashPasteButton_clicked()
{
    // Paste text from clipboard into recipient field
