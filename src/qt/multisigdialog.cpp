...
void MultisigDialog::on_transaction_textChanged()
{
    ...
    int64_t minFee = (int64_t)(transactionSize * (MIN_TX_FEE / 1000));
    if (fee < minFee) {
...
void MultisigDialog::on_sendTransactionButton_clicked()
{
    ...
    ui->statusLabel->setText(tr("The transaction is sent to galaxycash network."));
}
